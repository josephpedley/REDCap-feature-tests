...
describe('Data Quality Module functionality', () => {
  ...
  DataQualityRulesPage.uploadRuleByCsv('C418100TEST_DataQualityRules_Upload.csv', null)
    ...
    DataQualityRulesPage.assertRuleRow( '3', 'Integer',  "[event_1_arm_1][integer]='1999'", 0 ); //Slight anomaly here, total discrepencies differ by 1 (not important in testing the feature)
    ...
    DataQualityRulesPage.editExistingRule("[event_1_arm_1][integer]='1999'", "[event_1_arm_1][integer]='1'")
     ...
     //REDCap feature viewer says 'should see a row - rule #3m Rule Name: Integer, Rule Logic: [event_1_arm_1][integer]='1999'  - which makes no sense as we edited this rule
